...
The recommended delivery plan for remaining work is to confirm combat/HP/death-save/exploding-damage rules (UC-004B through UC-007), then populate published content through UC-009 after this infrastructure.
